							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4 col-lg-4">
										...
										<div class="form-group">
											<label>Default</label>
											<input class="form-control spinner spinner-left"  id="spinner" name="spinner" value="1" type="text">
										</div>
									...
									<div class="col-sm-6 col-md-4 col-lg-4">
										<div class="form-group">
											...
											<input class="form-control spinner"  id="spinner-decimal" name="spinner-decimal" value="7.99">
										</div>
									</div>
									<div class="col-sm-12 col-md-4 col-lg-4">
										<div class="form-group">
											<label>Increment spinner</label>
											<input class="form-control spinner spinner-both"  id="spinner-currency" name="spinner-currency" value="5">
										</div>
									</div>
								</div>
