						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								...
								<ul class="dropdown-menu pull-right" id="lang_change"> 
									...
									<li <?php echo @$_SESSION['lang'] == 'cn' ? 'class="active"' : '';?> >
										<a href="javascript:void(0);"><img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-cn" alt="China"><?php echo " ".$ui_lang_cn;?></a>
									</li>	
