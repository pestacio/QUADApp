...
$page_nav = array(
	...
	"admin" => array(
		...
		"sub" => array(
			"teste_db" => array(
				"title" => "Teste DB ORACLE",
				"url" => "ajax/blank_db.php"
			),
			"colabs" => array(
				"title" => "Colaboradores",
				"url" => "ajax/colabs.php"
			...
			"adm_user" => array(
				"title" => "Utilizador",
				"url" => "ajax/app_adm_user.php"
			),
			"configs" => array(
				"title" => "$ui_configs",
				"url" => "ajax/adm_configs.php"
			),
			"users_profiles" => array(
				"title" => "$ui_users_profiles",
				"url" => "ajax/adm_users_profiles.php"
			)
		)
	),
	"dashboard" => array(
	...
	"outlook" => array(
		...
		"sub" => array(
			...
			"email_view" => array(
				"title" => "Email view",
				"url" => "ajax/inbox-email-view.php"
			),
			"email_compose" => array(
				"title" => "Compose",
				"url" => "ajax/inbox-email-compose.php"
			),
			"email_reply" => array(
				"title" => "Reply",
				"url" => "ajax/inbox-email-reply.php"
			)
		)
	),
	"graphs" => array(
	...
	"misc" => array(
		...
		"sub" => array(
			"landing_page" => array(
			    ...
			    "url" => "http://192.241.236.31/themes/preview/smartadmin/1.8.x/Landing_Page/",
			    "url_target"=> "_blank"
		    ),
