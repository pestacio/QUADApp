...
# sSearch
     ...
     */
    $aColumns = array( 'CD_ARTIGO', 'DSP_ARTIGO', 'DT_INI_ARTG', 'DT_FIM', 'DESCRICAO' );
     
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "ROWIDTOCHAR(ROWID)";
